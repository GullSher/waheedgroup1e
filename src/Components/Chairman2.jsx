                    ...
                    <div className="padding-10-perc grey-bg background-80 background-no-repeat background-center">
                        ...
                        <div className="text-content mt-20">
                            ...
                            <p>
                                ...
                                Sohni Town on Adiala Road, in 1986 he stepped into the jewelry business and further
                                established himself in the business community. After this, Mr. Abdul Waheed stepped into
                                ...
                                established the first-ever private CNG filling station in Pakistan. In 1994 he became the
                                sole distributor for the Comparewheel Compressor in Pakistan. After establishing his name in
                                the CNG industry, He achieved yet another milestone by becoming the sole distributor of
                            ...
                            <ul style={{ listStyleType: 'circle', listStylePosition: 'outside', textAlign: 'left' }}>
                                <li><i className="fas fa-check-circle" style={{ color: 'blue' }}></i> VP Federation of Pakistan
                                    Chambers of Commerce (FPCCI) & Incharge Capital Office Islamabad</li>
